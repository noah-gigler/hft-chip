...
place_pad -row IO_WEST -location [expr {$westStart -  3*$westPitch}] "pad_market0_i"
place_pad -row IO_WEST -location [expr {$westStart -  4*$westPitch}] "pad_market1_i"
...
place_pad -row IO_SOUTH -location [expr {$southStart + 13*$southPitch}] "pad_op_i"
...
place_pad -row IO_EAST -location [expr {$eastStart +  3*$eastPitch}] "pad_market0_o"
place_pad -row IO_EAST -location [expr {$eastStart +  4*$eastPitch}] "pad_market1_o"
place_pad -row IO_EAST -location [expr {$eastStart +  5*$eastPitch}] "pad_side_o"
place_pad -row IO_EAST -location [expr {$eastStart +  6*$eastPitch}] "pad_qty0_o"
place_pad -row IO_EAST -location [expr {$eastStart +  7*$eastPitch}] "pad_qty1_o"
place_pad -row IO_EAST -location [expr {$eastStart +  8*$eastPitch}] "pad_qty2_o"
place_pad -row IO_EAST -location [expr {$eastStart +  9*$eastPitch}] "pad_qty3_o"
place_pad -row IO_EAST -location [expr {$eastStart + 10*$eastPitch}] "pad_qty4_o"
place_pad -row IO_EAST -location [expr {$eastStart + 11*$eastPitch}] "pad_qty5_o"
place_pad -row IO_EAST -location [expr {$eastStart + 12*$eastPitch}] "pad_qty6_o"
place_pad -row IO_EAST -location [expr {$eastStart + 13*$eastPitch}] "pad_qty7_o"
...
place_pad -row IO_NORTH -location [expr {$northStart - 11*$northPitch}] "pad_error_o"
place_pad -row IO_NORTH -location [expr {$northStart - 12*$northPitch}] "pad_message_type_i"
place_pad -row IO_NORTH -location [expr {$northStart - 13*$northPitch}] "pad_spare0_o"
